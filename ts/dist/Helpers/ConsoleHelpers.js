...
class ConsoleHelpers {
     ...
     */
    static writeWarningLine(message) {
        console.warn(message);
    }
    /**
     * Formats a configuration value for display.
     */
    static formatConfigValue(key, value, location) {
        let displayValue;
     ...
     */
    static displayConfigSetting(key, value, location) {
     ...
     */
    static displayLocationHeader(locationPath) {
     ...
     */
    static displayConfigSettings(locationPath, settings) {
     ...
     */
    static sortKeysWithNonDottedFirst(keys) {
