...
public static class ChatClientFactory
{
    ...
    {
        var model = Environment.GetEnvironmentVariable("") ?? "gpt-4o";
    ...
    {
        string model = Environment.GetEnvironmentVariable("COPILOT_MODEL") ?? "claude-3.7-sonnet";
    ...
    public static ChatClient CreateChatClientFromEnv()
    {
        ...
        throw new InvalidOperationException("No valid environment variables found for any ChatClient mode.");
    }
}
