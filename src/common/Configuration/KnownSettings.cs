...
public static class KnownSettings
{
    ...
    public const string FoundryLocalEndpoint = "Foundry.Local.Endpoint";
    public const string FoundryLocalModelId = "Foundry.Local.ModelId";
    ...
    private static readonly Dictionary<string, string> _dotToEnvVarMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        //Foundry Local mappings
        { FoundryLocalEndpoint, "FOUNDRY_LOCAL_ENDPOINT" },
        { FoundryLocalModelId,  "FOUNDRY_LOCAL_MODEL_ID"  },
    ...
    private static readonly Dictionary<string, string> _dotToCLIOptionMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        //Foundry local mappings
        { FoundryLocalEndpoint, "--foundry-local-endpoint" },
        { FoundryLocalModelId,  "--foundry-local-model-id"  },
    ...
    /// <summary>
    /// Collection of settings for Foundry local integration.
    /// </summary>
    public static readonly HashSet<string> FoundryLocalSettings = new(StringComparer.OrdinalIgnoreCase)
    {
