...
namespace ProcessExecution
{
    ...
    /// </summary>
    public static class EnhancedBackgroundProcessManager
    {
        ...
        /// </summary>
        static EnhancedBackgroundProcessManager()
        {
            ...
            try
            {
                ...
                _ = Task.Run(async () =>
                {
                    try
                    {
                        ...
                        ConsoleHelpers.WriteDebugLine($"Executing named process {processName} asynchronously");
