# cycodj stats Command - Filtering Pipeline Catalog
...
- **[Layer 9: Actions on Results](cycodj-stats-filtering-pipeline-catalog-layer-9.md)** ✅ ([proof](cycodj-stats-filtering-pipeline-catalog-layer-9-proof.md)) - **NOT IMPLEMENTED**
