# cycodj branches Command - Filtering Pipeline Catalog
...
- **[Layer 9: Actions on Results](cycodj-branches-filtering-pipeline-catalog-layer-9.md)** ✅ ([proof](cycodj-branches-filtering-pipeline-catalog-layer-9-proof.md)) - **NOT IMPLEMENTED**
